...
Module ProgramMain
    ...
    Public Sub BuildDebug()
        ...
        Try
            ...
            Directory.CreateDirectory(ProjectDirectory + "\Build\Debug\System\Config\Ext")
            ...
            Directory.CreateDirectory(ProjectDirectory + "\Build\Debug\System\Icons")
            ...
            File.Copy(ProjectDirectory + "\File Manager\Resources\folderblue_92960.png", ProjectDirectory + "\Build\Debug\Apps\File Manager\app_icon.png")
            File.Copy(ProjectDirectory + "\SystemDesktop\Resources\file-exe-icon_34440.png", ProjectDirectory + "\Build\Debug\System\Icons\executable.png")
    ...
    Public Sub BuildRelease()
        ...
        Try
            ...
            Directory.CreateDirectory(ProjectDirectory + "\Build\Release\System\Config\Ext")
            ...
            Directory.CreateDirectory(ProjectDirectory + "\Build\Release\System\Icons")
            ...
            File.Copy(ProjectDirectory + "\File Manager\Resources\folderblue_92960.png", ProjectDirectory + "\Build\Release\Apps\File Manager\app_icon.png")
            File.Copy(ProjectDirectory + "\SystemDesktop\Resources\file-exe-icon_34440.png", ProjectDirectory + "\Build\Release\System\Icons\executable.png")
